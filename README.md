...
|:--- |:--- |:--- |:--- |:--- |
| **[Hermeto](./Hermeto)** | [#1384](https://github.com/hermetoproject/hermeto/issues/1384) | Bug Discovery | Identified `JSONDecodeError` leaks in `npm` backend. Improved error resilience. | ![Resolved](https://img.shields.io/badge/Action-Resolved-8957e5?style=flat&logo=github&logoColor=white) |
